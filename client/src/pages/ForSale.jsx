...
function ForSale() {
  ...
  const fetchProperties = async () => {
    try {
      ...
      // Lọc chỉ lấy BDS bán (loại bỏ những cái có pricePerMonth)
      const forSaleProperties = response.data.filter(p => !p.pricePerMonth)
  ...
  const cities = [
    { label: 'Hồ Chí Minh (93.957)', value: 'hcm', count: 93957 },
    { label: 'Hà Nội (68.388)', value: 'hanoi', count: 68388 },
    { label: 'Đà Nẵng (10.670)', value: 'danang', count: 10670 },
    { label: 'Bình Dương (9.451)', value: 'binhduong', count: 9451 },
    { label: 'Khánh Hòa (5.674)', value: 'khanhhoa', count: 5674 },
    { label: 'Hải Phòng (4.384)', value: 'haiphong', count: 4384 },
    { label: 'Cần Thơ (4.378)', value: 'cantho', count: 4378 },
    { label: 'Hưng Yên (3.575)', value: 'hungyen', count: 3575 },
    { label: 'Bà Rịa-Vũng Tàu (3.344)', value: 'bariavungtau', count: 3344 }
  ]
